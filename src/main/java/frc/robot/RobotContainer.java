...
public class RobotContainer {
  ...
  public void simulationInit() {
    ...
    SmartDashboard.putData("Place 1 Position", (Sendable) m_armWristSubsystem.getGotoCommand(130, 0));
    SmartDashboard.putData("Place 2 Position", (Sendable) m_armWristSubsystem.getGotoCommand(130, 90));
